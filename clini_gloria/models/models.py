...
# class clini_gloria(models.Model):
#     _name = 'clini_gloria.clini_gloria'
...
class doctor_clini_gloria(models.Model):
    _name="doctor.clini_gloria"
    _rec_name="codigo"
    ...
    sus_tratamientos=fields.One2many(string="Atenciones/Tratamiento",comodel_name="historial.clini_gloria",inverse_name="doctor")
class unidad_clini_gloria(models.Model):
    _name="unidad.clini_gloria"
    _rec_name="id"
...
class paciente_clini_gloria(models.Model):
    _name="paciente.clini_gloria"
    _rec_name="ss"
    ...
    unidad=fields.Many2one(string="Unidad de ingreso",comodel_name="unidad.clini_gloria")
    sus_ingresos=fields.One2many(string="Ingresos",comodel_name="historial.clini_gloria",inverse_name="paciente")
class historial_clini_gloria(models.Model):
    _name="historial.clini_gloria"
    ...
    doctor=fields.Many2one(string="Médico asignado",comodel_name="doctor.clini_gloria")
    paciente=fields.Many2one(string="Paciente",comodel_name="paciente.clini_gloria")